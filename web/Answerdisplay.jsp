...
<div class="container-fluid" style="background-image:url('21.jpeg');padding:20%;width:100%;">
		...
		<form method = "post" action= "GetAnswer" style="border:2px solid orange;width:37%;margin-left:32%;">
			<p style="color:black;"><b>Enter the Q_id</b><input type="text" cols='8' rows='8' name="qid"  %> required></p>
    ...
    <center><p style = "color:black"><b>Answer of Your Question: <textarea rows="3" cols="50"><%=request.getAttribute("answer").toString() %></textarea></b></p></center><br>
    <center><p><b>Answered By : <%= request.getAttribute("UserName").toString() %></b></p></center>
